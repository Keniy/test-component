...
<div class="SearchPage page-layout">
  <div class="tool">
    ...
    第 <input :style="{'width':'50px', 'height':'28px', 'border': '1px solid #dde6e9'}" type="number" @compositionstart="compositionstart" @compositionend="compositionend" @input="compositioninput" v-model="pageIndex"/> 页
    共{{totalPages}}页
